...
const dataList = [
    {
        ...
        "analytics": {
            "context": "seo-data-52938d48-75ac-4973-9755-2cd75a2fcb45"
        },
        "cta": {
    ...
    return (
        <div className='header'>
            <div className='logo_container'>
                <img className="logo" src="https://static.vecteezy.com/system/resources/thumbnails/008/687/818/small/food-delivery-logo-free-vector.jpg" />
            </div>
...
const Footer = () => {
    return (
        <div className='footer'>
            <div className='copy-rights'>Copyrights @2024</div>
            <div className='links'>
                <ul>
                    <li>About Us</li>
                    <li>Contact Us</li>
